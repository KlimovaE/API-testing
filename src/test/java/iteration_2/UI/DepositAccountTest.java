...
public class DepositAccountTest extends BaseUiTest {
    ...
    public void setupLocalStorage() {
        CreateAccountResponse response = AccountCreationSteps.createAccount(getCurrentUserToken());
    ...
    public void userCanDepositAccountTest() {
        ...
        double actualBalance = GetActualBalanceSteps.getActualAccountBalance(getCurrentUserToken(), accountId);
